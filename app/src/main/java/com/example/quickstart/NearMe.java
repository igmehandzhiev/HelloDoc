...
public class NearMe extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, OnMapReadyCallback, GoogleMap.InfoWindowAdapter {
    ...
    private static final String TAG = "NEAR_ME_TESTING";
...
//        }
    ...
    private void getDeviceLocation() {
        ...
        if (mLocationPermissionGranted) {
            if (ActivityCompat.checkSelfPermission(this,
                    ...
                    != PackageManager.PERMISSION_GRANTED) {
                Log.d(TAG, "TEST.FINE_LOCATION_and_COARSE_PERMISSION");
            ...
            Log.d(TAG, "TEST.LAST_LOCATION_CHANGED");
        }

        // Set the map's camera position to the current location of the device.
        if (mCameraPosition != null) {
            mMap.moveCamera(CameraUpdateFactory.newCameraPosition(mCameraPosition));
            Log.d(TAG, "TEST.mCAMERA_POSITION_!NULL");
        } else if (mLastKnownLocation != null) {
            Log.d(TAG, "TEST.mLAST_LOCATION_!NULL");
            ...
            Log.d(TAG, "TEST.POSITION_LOCATION_NULL");
    ...
    public void onMapReady(GoogleMap map) {
        ...
        getDeviceLocation();
        Log.d(TAG, "TEST.set_info_adapter");
        mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoContents(Marker marker) {
                ...
                Log.d(TAG, "TEST.GET_INFO_CONTENTS");
                return infoWindow;
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Log.d(TAG, "TEST.onOptionsItemSelected");
        if (item.getItemId() == R.id.current_place) {
            showCurrentPlace();
        }
        return true;
    }
    ...
    private void showCurrentPlace() {
        ...
        if (mLocationPermissionGranted) {
            ...
            Log.d(TAG, "TEST.showCurrentPlace");
